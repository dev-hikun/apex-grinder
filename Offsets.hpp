...
constexpr long OFF_IN_FORWARD = 0x073ce8f0;                   //[Buttons]->in_forward
...
constexpr long OFF_WEAPON_AMMO = 0x1514;                      //[RecvTable.DT_PropSurvival]->m_ammoInClip
...
constexpr long OFF_TIME_BASE = 0x2048;                        //[RecvTable.DT_Player]->m_currentFramePlayer.timeBase
